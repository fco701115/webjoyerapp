        ...
        <div className="fixed inset-0 z-[100] flex justify-end">
            ...
            <div className="relative w-full max-w-[420px] bg-white h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-500 ease-out border-l border-slate-100">
                ...
                <div className="flex-1 overflow-y-auto p-8 space-y-10 custom-scrollbar">
                    ...
                    <div className="space-y-5">
                        <div className="flex items-center gap-2">
                            <div className="w-1.5 h-4 bg-[#198754] rounded-full" />
                            ...
                            {[
                                ...
                                <button
                                    ...
                                    className={`flex items-center justify-between p-5 rounded-[24px] border-2 transition-all duration-300 font-bold group ${
                                        sort === option.id 
                                        ? 'border-[#198754] bg-green-50/30 text-[#198754] shadow-sm' 
                                ...
                                >
                                    ...
                                    {sort === option.id ? (
                                        <div className="w-6 h-6 bg-[#198754] rounded-full flex items-center justify-center text-white">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="flex-1 space-y-2.5">
                                    ...
                                    <div className="relative group">
                                        <span className="absolute left-4 top-1/2 -translate-y-1/2 font-bold text-slate-300 group-focus-within:text-[#198754] transition-colors">$</span>
                                        <input
                                            type="number"
                                            value={minPrice}
                                            onChange={(e) => setMinPrice(e.target.value)}
                                            placeholder="0"
                                            className="w-full pl-8 pr-4 py-4 bg-white border-2 border-white rounded-2xl font-black text-slate-900 focus:border-[#198754] focus:ring-4 focus:ring-green-100 transition-all outline-none shadow-sm"
                                        />
                                    </div>
                                </div>
                ...
                <div className="p-8 border-t border-slate-100 bg-white grid grid-cols-5 gap-4 sticky bottom-0 z-10 shadow-[0_-10px_30px_-15px_rgba(0,0,0,0.05)]">
                    ...
                    <button
                        onClick={handleApply}
                        className="col-span-3 px-8 py-5 bg-[#198754] hover:bg-slate-900 text-white rounded-[24px] font-black shadow-2xl shadow-green-500/30 active:scale-[0.97] transition-all flex items-center justify-center gap-3 uppercase tracking-[0.2em] text-[11px] group overflow-hidden relative"
                    >
