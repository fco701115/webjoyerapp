                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="flex gap-4 mb-2">
                            ...
                            <a href="tel:+15551234567" className="flex-1 bg-[#198754] hover:bg-green-600 text-white font-bold h-12 rounded-xl flex items-center justify-center gap-2 transition-colors shadow-sm active:scale-95 text-[14px]">
                                <Phone size={18} />
                                Llamar
                            </a>
                        </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-6">
                                    <div className="flex gap-4">
                                        <div className="w-12 h-12 bg-green-50 text-[#198754] rounded-2xl flex items-center justify-center flex-shrink-0">
                                            <Phone />
                                        </div>
                                        <div>
                    ...
                    <div className="lg:col-span-3">
                        <div className="bg-white p-8 md:p-10 rounded-3xl shadow-sm border border-slate-100">
                            ...
                            <form className="space-y-6" onSubmit={async (e) => { 
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            className="w-full h-12 px-4 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-[#198754] transition-all font-medium text-[15px]"
                                            required
                                        />
                                    </div>
                                    <div className="space-y-2">
                                ...
                                <button
                                    type="submit"
                                    className="w-full md:w-auto px-8 h-12 bg-[#198754] hover:bg-green-600 text-white font-bold rounded-xl transition-all shadow-lg shadow-green-500/30 flex items-center justify-center gap-2"
                                >
                                    Enviar Mensaje
                                    <Send size={18} />
                                </button>
