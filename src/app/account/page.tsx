                                ...
                                <div className="p-4 space-y-4">
                                    {isLoading ? (
                                        ...
                                        orders
                                            ...
                                            .map((order, i) => (
                                                <div key={i} className="flex flex-col p-5 bg-slate-50/50 rounded-[32px] border border-slate-100 hover:border-green-100 hover:bg-white transition-all group overflow-hidden">
                                ...
                                <div className="p-8">
                                    {wishlist.length === 0 ? (
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            {wishlist.map((item, i) => (
                                                <div key={i} className="flex gap-4 p-4 bg-slate-50/50 rounded-3xl border border-slate-100 hover:border-green-100 transition-all group relative">
